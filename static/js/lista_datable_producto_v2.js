...
$(document).ready(function () {
    ...
    if(separa_suc.length == 2){
        ...
        //otra forma de seleccionar al dar click .name es la clase que esta en el button
                ...
                $.get('/operaciones/muestra_kardex_codigo', {
                    ...
                    var table = $('#TablaKardex').DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'FOLIO'},
                            { data: 'MOVIMIENTOS'},
                            { data: 'ENT', className:'text-end' },
                            { data: 'SAL', className:'text-end'},
                            { data: 'EXIST', className:'text-end'},
                            { data: 'COSTO', className:'text-end'},
                            { data: 'MOV_ENT', className:'text-end'},
                            { data: 'MOV_SAL', className:'text-end'},
                            { data: 'MOV_INV', className:'text-end'},
                        ],
                        language: {
                            url: "/static/json/sys_lenguaje_datatable.json"
                        },
                        footerCallback: function ( row, data, start, end, display ) {
                            ...
                            $( api.column( 6 ).footer() ).html(entTotal);
                            $( api.column( 7 ).footer() ).html(salTotal);
                            $( api.column( 8 ).footer() ).html(stockTotal);
                            $( api.column( 10 ).footer() ).html(impETotal);
                            $( api.column( 11 ).footer() ).html(impSTotal);
                            $( api.column( 12 ).footer() ).html(impStockTotal);
                        },
                    });
                    // setInterval (function () {
                    // table.ajax.reload (null, false);
                    // console.log('reload kardex');
...
function SumaImporteKardex() {
    document.getElementById("SumaEnt").textContent = '';
    document.getElementById("SumaSal").textContent = '';
